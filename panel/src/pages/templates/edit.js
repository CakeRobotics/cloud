...
class EditTemplate extends Component {
    ...
    async componentDidMount() {
        const response = await axios.get(`/api/templates/all/${this.props.match.params.templateId}`);
        var template = response.data;
        delete template._id;
        this.setState({ template, json: JSON.stringify(template) });
    }
    ...
    async post() {
        try {
            ...
            const response = await axios.put(
                `/api/templates/all/${this.props.match.params.templateId}`,
                this.state.template,
